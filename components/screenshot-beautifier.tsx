...
export function Clyp() {
  ...
  const [exportAction, setExportAction] = useState<"copy" | "download">("download")
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid gap-8 md:grid-cols-[1fr_300px]">
          <div className="space-y-4">
            ...
            <div className="bg-slate-100 rounded-sm p-6 flex items-center justify-center">
              {image ? (
                <div
                  ref={screenshotRef}
                  className={cn(
                ...
                >
                  ...
                  >
                    <div className="relative">
                      {styleOptions.showWindowNavbar && <WindowNavbar dark={styleOptions.windowNavbarDark} />}
                      <div
                ...
                <Card className="w-full max-w-md flex flex-col items-center justify-center p-8 shadow-none rounded-sm">
